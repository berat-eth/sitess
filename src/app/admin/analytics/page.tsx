...
import { mockSystemMetrics } from '@/data/adminData';
      ...
      <div>
        ...
        {change && (
          <p className="text-sm text-green-600 mt-1">
            <span className="font-medium">{change}</span> son 30 gün
          </p>
        )}
      </div>
    ...
    <div className="space-y-8">
      ...
      >
        <div>
          ...
          <p className="text-gray-600 mt-1">Detaylı sistem istatistikleri ve performans metrikleri</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <AnalyticsCard
          title="Toplam Gelir"
          value={`₺${mockSystemMetrics.totalRevenue.toLocaleString()}`}
          change="+15%"
          icon={
        ...
        <AnalyticsCard
          title="API Çağrıları"
          value={mockSystemMetrics.apiCalls.toLocaleString()}
          change="+8%"
          icon={
            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <AnalyticsCard
          ...
          value={`%${mockSystemMetrics.storageUsed}`}
          icon={
            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <AnalyticsCard
          ...
          value={mockSystemMetrics.activeUsers}
          change="+23%"
          icon={
            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900">Sistem Performansı</h3>
        </div>
        <div className="p-6">
