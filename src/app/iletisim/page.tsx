...
export default function IletisimPage() {
  const contactInfo = [
    {
      title: 'Adres',
      content: 'Aliçetinkaya mahallesi 3076 sk no:6/6\nAyvalık, Balıkesir',
      icon: (
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12">
            ...
            <a
              href="mailto:info@mikarastirma.com"
              className="border-2 border-white hover:bg-white/10 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors duration-200 inline-flex items-center justify-center backdrop-blur-sm"
            >
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ayvalık, Balıkesir'deki ofisimizde yüz yüze görüşme imkanı.
            </p>
          </div>
          ...
          <div className="relative rounded-2xl h-96 overflow-hidden">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Ofis Konumumuz</h3>
              <p className="text-gray-100 mb-4">
                Aliçetinkaya mahallesi 3076 sk no:6/6<br />
                Ayvalık, Balıkesir
              </p>
              <a
